...
public class CombatTest {
	public static void main(String[] args) {
		...
		while(p.getHP() > 0 && m.getHP() > 0) {
			...
			System.out.println(p.getName() +" HP: " + p.getHP() + "/" + p.getMaxHP() + " Mana: " + p.getMana() + "/" + p.getMaxMana());
			System.out.println(m.getName() +" HP: " + m.getHP() + "/" + m.getMaxHP() + " Mana: " + m.getMana() + "/" + m.getMaxMana());
			System.out.println("==============================================");
			try{
